...
# shipping_data_platform documentation build
...
from shipping_data_platform import __version__ as release

# -- Project information -----------------------------------------------------

project = "shipping_data_platform"
author = "Kedro"
...
htmlhelp_basename = "shipping_data_platformdoc"
...
latex_documents = [
    (
        master_doc,
        "shipping_data_platform.tex",
        "shipping_data_platform Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "shipping_data_platform",
        "Project shipping_data_platform codebase.",
        "Data-Science",
    )
]
